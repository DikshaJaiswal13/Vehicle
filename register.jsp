...
<body>
	...
	<div class="container">
		...
		<center><h2><ins><b>Register</b></ins></h2></center>
		<form action="/action_page.php" class="needs-validation" novalidate>
		
			<div class="form-group">
				<label for="uname">First Name:</label> <input type="text"
					maxlength="6" class="form-control" id="firstName"
			...
			<div class="form-group">
				<label for="uname">Gender:</label>&nbsp;&nbsp;&nbsp;&nbsp;<br> <select
												name="gender">
												<option value=" "></option>
			...
			<div class="form-group">
				<label for="uname">Contact no:</label> <input type="text"
					...
					placeholder="Enter contact no" name="contactNumber" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback">Please fill out this field.</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="uname">Confirm password:</label> <input type="text"
					class="form-control" id="cpassword"
					placeholder="Retype password" name="cpassword" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback">Please fill out this field.</div>
			</div>
			...
			<div class="form-group">
				<label for="uname">Branch:</label> <input type="text"
					...
					placeholder="Enter branch" name="branch" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback">Please fill out this field.</div>
			</div>
